...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "gwt_appnavigation" because\n';
  ...
  $wnd.__gwt_activeModules['gwt_appnavigation'] = {
    'moduleName' : 'gwt_appnavigation',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/gwt_appnavigation.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['gwt_appnavigation'].superdevmode = true;

  var expectedSuffix = '/gwt_appnavigation.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + gwt_appnavigation + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:gwt_appnavigation';
  var devModeSessionKey = '__gwtDevModeSession:gwt_appnavigation';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/gwt_appnavigation/gwt_appnavigation.nocache.js';
  ...
  $wnd.__gwt_activeModules['gwt_appnavigation'].canRedirect = true;
  $wnd.__gwt_activeModules['gwt_appnavigation'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING gwt_appnavigation';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/gwt_appnavigation?user.agent=' + ua + '&_callback=' + callback;
